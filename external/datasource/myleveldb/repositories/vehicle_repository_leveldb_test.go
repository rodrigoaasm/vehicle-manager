...
var car = entities.NewCar("a154", "VW GOL", "black", "14885511T125T")
var truck = entities.NewTrunk("a156", "VW CONSTELLATION", "white", "2885511T125E")
...
func TestGetAllVehicleById(t *testing.T) {
